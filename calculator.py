...
class Calculator(tk.Tk):
    def __init__(self):
        ...
        for button in buttons:
            ...
            tk.Button(self,text=button,background='lightblue', width=5,command=button_action).grid(
        ...
        #memory buttons
        tk.Button(self,text='M+',width=5,command=self.memory_add).grid(row=6,
                                                        column=1,padx=5,pady=5)
        tk.Button(self,text='M-',width=5,command=self.memory_subtract).grid(row=6,
                                                        column=2,padx=5,pady=5)
        tk.Button(self,text='MR',width=5,command=self.memory_recall).grid(row=6,
                                                        column=3,padx=5,pady=5)
        tk.Button(self,text='MC',width=5,command=self.memory_clear).grid(row=6,
        ...
        #history log
        self.history_text = tk.Text(self,width=15,height=5)
        self.history_text.grid(row=1,column=5,rowspan=5,padx=15,pady=5)
